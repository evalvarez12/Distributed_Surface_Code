...
mpiexec python result_one_point_tau.py topology=toric distance=10 iterations=100 cycles=10 protocol=thres_tau tau=0 time=0.0 mode=1
created-on: 09/12/17
@author: eduardo
"""
import sys
...
import layers
import matching
import decomposition.tools.fgh as fgh
