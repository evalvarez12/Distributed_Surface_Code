...
class SurfaceCode:
    ...
    def __init__(self, distance, surface):
        # Tim: rename 'surface' to 'topology_type' or something like that
        """
        Init func.
    ...
    def init_error_obj(self, surface, ps, pm, pg, eta, a0, a1, theta, protocol):
        ...
        """
        self.errors = faulttolerance.errors.Generator(surface=self.surface, ps=ps, pm=pm,
    ...
    def init_error_obj_extra(self, surface, ps, pm, pg, eta, a0, a1, theta, protocol):
        self.errors_extra = faulttolerance.errors.Generator(surface=self.surface, ps=ps,
